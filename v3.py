...
def main() -> int:
    ...
    ap.add_argument("--prompt", default="v4", choices=["v4", "v5", "v6", "v7", "v8", "v9", "v10"])
    a = ap.parse_args()
    ...
    system, fewshot = {
        ...
        "v9": (prompts_v9.SYSTEM_V9, prompts_v9.FEWSHOT_V9),
        "v10": (prompts_v10.SYSTEM_V10, prompts_v10.FEWSHOT_V10),
    }[a.prompt]
